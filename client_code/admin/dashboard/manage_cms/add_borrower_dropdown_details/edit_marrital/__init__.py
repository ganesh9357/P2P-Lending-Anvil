...
class edit_marrital(edit_marritalTemplate):
  def __init__(self,selected_row, **properties):
    ...
    self.text_box_1.text = selected_row['borrower_marrital_status']
  ...
  def button_1_click(self, **event_args):
    ...
    self.selected_row['borrower_marrital_status'] = update
  ...
  def delete_button(self, **event_args):
    ...
    if confirmation:
            ...
            name = self.selected_row['borrower_marrital_status']
