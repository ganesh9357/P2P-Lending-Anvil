from ._anvil_designer import lending_typeTemplate
from anvil import *
import anvil.server
...
class lending_type(lending_typeTemplate):
  def __init__(self,selected_row, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)
    self.text_box_1.text = selected_row['lendor_lending_type']
  ...
  def button_1_click(self, **event_args):
    ...
    self.selected_row['lendor_lending_type'] = update
  ...
  def delete_button(self, **event_args):
    ...
    if confirmation:
            ...
            name = self.selected_row['lendor_lending_type']
